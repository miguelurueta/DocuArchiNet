<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormPaswordRadicacion.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormPaswordRadicacion" %>
...
<body>
    ...
    <div>
       <div id="superior" style="width:100%; height:30%;background-color: #E7EDF5; margin-bottom:10px" >
             <asp:Label ID="Label5" runat="server" Text="Cambiar contraseña Getión Correspondencia" Style="font-family:Arial; font-size:20px;color:black"></asp:Label>
         </div>
        <div id="contenido" style="width:100%; height:60%" >
                   ...
                   <asp:Label ID="Label2" runat="server" Text="Las contraseñas deben tener como mínimo ocho caracteres" Style="font-family: Arial; font-size:10px; margin-left:5px"></asp:Label>
                    ...
                    &nbsp &nbsp &nbsp &nbsp
                    <asp:TextBox ID="TextBox_pasword" runat="server" Style="width: 230px"  TextMode="Password" EnableViewState="false" ></asp:TextBox>
                    <br /> <br />
                    ...
                    &nbsp &nbsp
                    <asp:TextBox ID="TextBox_pasword_2" runat="server" Style="width: 230px"  TextMode="Password" EnableViewState="false"></asp:TextBox>   
                    <br />
                    <br />
