<%@ Page  Title="Reportes de gestion" Language="vb" AutoEventWireup="false"  CodeBehind="WebFormReportesRadicacion.aspx.vb"  Inherits="GestionDocumental_Docuarchi.net.WebFormReportesRadicacion" %>
...
<head runat="server">
  ...
  <script defer src="../Awesome/js/fontawesome.js"></script>
   <link href="../js/ui/jquery-ui.css" rel="stylesheet" />
    ...
    <script src="../js/radicacion/WebFormReportesRadicacion.js"></script>
    ...
    <form id="form1" runat="server">
        ...
        <div id="contendor_reporte" style="width: 100%; margin: 0px auto; height: 100%"  class="row">
            <div id="derecha" style="height: 100%; background-color:white; border-right:1px solid #F2F2F2" class="col-4 p-0">
                <div id="reportes" style=" height: 60%" class="d-block">
                   ...
                   <asp:Panel ID="Panel_reportes" runat="server" BackColor="white" ScrollBars="Auto"
                        ...
                        <asp:UpdatePanel ID="update_tre_principal" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:TreeView ID="TreeView1" runat="server" NodeWrap="true" CssClass="font-weight-light h6 pl-0  pt-0" SkipLinkText="#" Style="font-family:'Segoe UI'" 
                ...
                <div id="Opciones_bajo" style="width: 100%; display:none; height: 10%; float: right">

                    <asp:Label ID="label2" runat="server" Text="" Font-Size="8px" Style="margin-left: 20px"></asp:Label>
                </div>
            </div>
            <div id="resultados" style=" height: 90%; background-color:white;
             border:initial" class="col-8 p-0">
                <asp:UpdatePanel ID="UpdatePanel_conenido" runat="server" UpdateMode="Conditional" RenderMode="Block" style="width: 100%; height: 100%">
                    <ContentTemplate>
                        ...
                        <div id="div_pan_radicacion" style="overflow: auto">
                            <asp:GridView ID="GridView_val_radicacion" runat="server" Width="100%" EnableViewState="True" GridLines="None"
