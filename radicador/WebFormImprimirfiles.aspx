<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormImprimirfiles.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormImprimirfiles" %>
     ...
     <div id="ContenidoImpresion" style="border: thin double #000080; color:black; background-color: #FFFFFF; height:220px; width:450px">
                         <asp:Table ID="Table1" runat="server" Style="width:450px; height:200px ">
                             <asp:TableRow ID="impresion">
                                 <asp:TableCell>
                                      <label style="color: #0000FF; font-family: Arial"> Datos de Radicación</label>
                                 </asp:TableCell>
                                  <asp:TableCell>
                             ...
                             <asp:TableRow ID="user">
                                 <asp:TableCell>
                                      <label id="usuario"> Usuario Radicador </label>
                                 </asp:TableCell>
                                  <asp:TableCell>
                                      <label id="usuario_datos" runat="server">  </label>
                                 </asp:TableCell>
                             </asp:TableRow>
                             <asp:TableRow ID="radicado">
                                 <asp:TableCell>
                                      <label id="radicad" style="color: #FF0000; font-family: Arial; font-size: large"> Consecutivo Radicado </label>
                                 </asp:TableCell>
                                  <asp:TableCell>
                             ...
                             <asp:TableRow ID="barra">
                                 <asp:TableCell>
                                      <label id="barr">Codigo Barras</label>
                                 </asp:TableCell>
                                 <asp:TableCell>
                             ...
                             <asp:TableRow ID="fecha">
                                 <asp:TableCell>
                                      <label id="fech"> Fecha Radicado</label>
                                 </asp:TableCell>
                                  <asp:TableCell>
                             ...
                             <asp:TableRow ID="seleccion">
                                 <asp:TableCell>
                                      <label id="Sel"> Modo impresion</label>
                                 </asp:TableCell>
                                 <asp:TableCell>
