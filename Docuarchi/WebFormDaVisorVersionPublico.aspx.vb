...
Public Class WebFormDaVisorVersionPublico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Page.IsPostBack = False Then
                ...
                Result = Class_ra_con_registros_publicos.Load_visor_tiff_consulta_publica(HttpContext.Current.Session.Item("DA_IMAGEN"),
    ...
    Private Sub WebFormDaVisorVersionPublico_Init(sender As Object, e As EventArgs) Handles Me.Init
