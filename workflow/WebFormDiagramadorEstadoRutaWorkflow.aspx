<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormDiagramadorEstadoRutaWorkflow.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormDiagramadorRutaWorkflow" %>
...
<body>
    <form id="form1" runat="server">
         <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True" AsyncPostBackTimeout="300000">
            <Scripts>
    ...
    <div>
        ...
        <div id="header" class="modal_content_no_back_inferior_ border_general_" style="background-color:white" >        
         ...
         <asp:UpdatePanel ID="UpdatePanel_diagran_view" runat="server" UpdateMode="Conditional" style="display:block">
            <ContentTemplate>
        ...
        <!--detalle_conector_trazabilidad!-->
         <div id="detalle_conector_trazabilidad">
            <asp:Panel ID="Panel_detalle_conector_trazabilidad" runat="server"  Style="display:none;  height:auto; width:auto" CssClass="modal_content_general">              
                ...
                <div id="Contenido_detalle_conector_trazabilidad" style=" height: auto; width: auto" class="modal-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_detalle_conector_trazabilidad" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-6">
                                            <asp:TextBox ID="TextBox_Duracion_Inicio_Seleccion" runat="server"  CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <asp:TextBox ID="TextBox_Duracion_Seleccion_Fin" runat="server"  CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-6">
