<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormEnviaUsuario.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormPendiente" %>
...
<head runat="server">
   ...
   <!-- <script src="../js/ScrollableGridPlugin.js"></script> !-->
    ...
    <script src="../js/workflow/WebFormEnviaUsuario.js"></script>
...
<body style=" ">
    ...
    <div>
        ...
        <div id="contenido_label" style="width:100%; height:20%; text-align:center; padding-top:5px" class="border_superior_radius">
            ...
            <asp:Label ID="Label_titulo" runat="server" Text="Usuarios disponibles" style="font-family:Arial; color:black; font-size:14px"></asp:Label>
        </div>
        <div id="Lista" style="width: 100%; position: inherit; height:60%;  margin-top: 1px; border-color: #b0c4de; border-style: ridge; border-width: 1px">
            ...
            <div id="contenido_botonoes" style="width: 100%; position: inherit; left: auto; float: right; height: 20%">
                <asp:UpdatePanel ID="updatepnael_botones" runat="server" UpdateMode="Conditional"  >
                    <ContentTemplate>
                         <asp:TextBox ID="contenidobusqueda" runat="server" style="left:30px; width:250px; margin-left:1px; margin-top:3px"></asp:TextBox>
