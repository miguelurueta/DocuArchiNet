# app-toolbar Specification

## Purpose
Definir el componente reusable `AppToolbar` como primitive compartido para encabezados contextuales, acciones y contenido auxiliar con comportamiento responsive, accesibilidad consistente y adopcion segura por los modulos del proyecto.
