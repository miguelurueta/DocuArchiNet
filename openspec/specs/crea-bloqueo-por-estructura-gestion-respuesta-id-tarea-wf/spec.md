# crea-bloqueo-por-estructura-gestion-respuesta-id-tarea-wf Specification

## Purpose
TBD - created by archiving change scrumcore-143-crea-bloqueo-por-estructura-gestion-respuesta-id-tarea-wf. Update Purpose after archive.
## Requirements
