# refinar-apptablequerywrapper Specification

## Purpose

Define el refinamiento de controles de `AppTableQueryWrapper` para mantener paginacion inicial consistente, controles de accion basados en `AppButton`, selector de tamano de pagina basado en `AppDropdown` y estilos locales para los inputs del wrapper.
