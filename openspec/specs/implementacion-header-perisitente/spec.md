# implementacion-header-perisitente Specification

## Purpose
Definir el comportamiento del listado documental en `DocumentosWorkbench` para mantener header visible con scroll interno, preservando separacion entre documento activo y seleccion multiple, sin impacto global en otras tablas.
## Requirements
