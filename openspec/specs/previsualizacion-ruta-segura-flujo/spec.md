# previsualizacion-ruta-segura-flujo Specification

## Purpose

Define el contrato de solo lectura para previsualizar destinos de tareas Workflow mediante un ASMX paralelo, preservando la ejecución Web Forms existente.
