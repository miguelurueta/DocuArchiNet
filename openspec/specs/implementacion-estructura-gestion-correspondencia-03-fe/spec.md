...
Definir la estructura modular y los requisitos funcionales para la UI de
`GestionCorrespondencia` en `GestionRespuesta`, manteniendo la orquestacion de tabs
sin introducir efectos colaterales en otros modulos.
