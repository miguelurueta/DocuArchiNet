# app-appvisorpdf-02-fe Specification

## Purpose
Estandarizar el motor PDF real de `AppVisorPdf` (Ticket: `SCRUMCORE-191`) usando `pdfjs-dist`,
asegurando rendimiento en PDFs grandes mediante **virtualizaci\u00f3n** y **cache**, manteniendo el
engine desacoplado de la UI y con tipado estricto.
