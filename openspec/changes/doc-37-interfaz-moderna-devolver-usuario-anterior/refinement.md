...
La etapa está aprobada para completar la arquitectura de pruebas. La validación cubrirá contratos exclusivos, ausencia de ruta heredada, accesibilidad, actualización localizada y el runner DOC-37. La E2E autenticada queda fuera de esta ejecución hasta recibir autorización explícita de ambiente y cuentas de prueba.
