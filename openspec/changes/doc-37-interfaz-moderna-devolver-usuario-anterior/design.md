...
### D-07 — Validación CI reproducible

El workflow `opsxj-validation.yml` fija `@fission-ai/openspec@1.7.0` para validar todo el repositorio. No se usa `@latest`: esa variante introdujo reglas incompatibles con cuatro especificaciones base ajenas a DOC-37, mientras 1.7.0 valida las treinta especificaciones y coincide con la CLI local del repositorio.
