...
- [x] 2.3 Implementar organizador de paginas como overlay sobre preview.
- [x] 2.4 Reutilizar `scanner.pages` y handlers existentes sin regenerar miniaturas.

## 3. Pruebas

- [x] 3.1 Agregar/ajustar pruebas unitarias e integracion.
- [x] 3.2 Ejecutar suite afectada y registrar evidencia.
- [x] 3.3 Cubrir apertura/cierre del overlay, seleccion multiple, drag/drop y virtualizacion.

## 4. Cierre

- [x] 4.1 Validar OpenSpec.
- [x] 4.2 Documentar diff final y decisiones de arquitectura.
- [x] 4.3 Documentar `SCRUMCORE-267B-page-organizer-overlay.md`.
