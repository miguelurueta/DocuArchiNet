...
INTEGRAR-CENTRO-TRABAJO-NOTA. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-43.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: CENTRO, INTEGRAR, NOTAS, TRABAJO

## Capabilities

### New Capabilities
- `integrar-centro-trabajo-nota`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
