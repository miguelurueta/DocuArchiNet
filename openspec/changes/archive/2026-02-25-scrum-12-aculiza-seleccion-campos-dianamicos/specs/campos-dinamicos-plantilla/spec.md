...
#### Scenario: Consistencia visual en seleccion dinamica
- **WHEN** se renderiza un campo dinamico `SELECCION`
- **THEN** el control refleja estilo consistente con los campos estaticos del formulario para estados base, hover y focus, sin perder atributos funcionales y de accesibilidad
