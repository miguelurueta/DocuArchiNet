...
Esta especificación implementa D-01 (historial inmediato), D-02 (token), D-03 (lock), D-04 (autorización y auto-devolución), D-05 (adaptador mutante), D-06 (política sin respuestas) y D-07 (auditoría saneada).
