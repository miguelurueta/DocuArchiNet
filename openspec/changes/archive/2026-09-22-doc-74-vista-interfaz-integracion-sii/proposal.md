...
VISTA-INTERFAZ-INTEGRACION-SII. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-74.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: INTEGRACION, INTERFAZ, SII, VISTA

## Capabilities

### New Capabilities
- `vista-interfaz-integracion-sii`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
