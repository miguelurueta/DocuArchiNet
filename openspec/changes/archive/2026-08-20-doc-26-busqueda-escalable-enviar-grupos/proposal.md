...
BUSQUEDA-ESCALABLE-ENVIAR-GRUPOS. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-26.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: BUSQUEDA, ESCALABLE

## Capabilities

### New Capabilities
- `busqueda-escalable-enviar-grupos`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
