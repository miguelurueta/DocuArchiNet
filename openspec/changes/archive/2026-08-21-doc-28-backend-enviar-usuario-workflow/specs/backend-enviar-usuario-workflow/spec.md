...
# Backend seguro de Enviar a usuario
...
### Requirement: Contrato directo y exclusivo de usuario (D-01, RQ-01)
...
### Requirement: Autorización calculada en servidor (D-02, RQ-02)
...
### Requirement: Preview de destinos autorizado y de solo lectura (D-03, RQ-03)
...
### Requirement: Ejecución reautorizada y concurrente (D-04, RQ-04)
...
### Requirement: Adaptador directo, resultados y auditoría (D-05, D-06, RQ-05)
...
### Requirement: Aislamiento y evidencia de regresión (D-07, RQ-06)
