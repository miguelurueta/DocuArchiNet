...
BACKEND-ENVIAR-USUARIO-WORKFLOW. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-28.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: BACKEND, ENVIAR, USUARIO

## Capabilities

### New Capabilities
- `backend-enviar-usuario-workflow`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
