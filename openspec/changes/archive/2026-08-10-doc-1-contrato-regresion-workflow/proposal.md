...
CONTRATO-REGRESION-WORKFLOW. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-1.
...
### New Capabilities
- `contrato-regresion-workflow`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
