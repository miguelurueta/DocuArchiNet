...
LECTURA-LISTADO-CONTADOR. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-41.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: CONTADOR, LECTURA, LISTADO

## Capabilities

### New Capabilities
- `lectura-listado-contador`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
