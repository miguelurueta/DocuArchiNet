...
PROTECCION-CONTEXTO. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-78.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: CONTEXTO, PROTECCION

## Capabilities

### New Capabilities
- `proteccion-contexto`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
