...
CONTRATOS-MULTI-PROVEEDOR. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-50.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: CONTRATO, MULTI, PROVEEDOR

## Capabilities

### New Capabilities
- `contratos-multi-proveedor`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
