...
CREA-COMPONENTE-APPHORIZONTALSCROLLER. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue SCRUMCORE-297.
- Se formaliza la propuesta OpenSpec para implementar AppApphorizontalscroller a partir del ticket Jira.
- Se define la capability `app-apphorizontalscroller` como parte de la capa UI reutilizable.
...
### New Capabilities
- `app-apphorizontalscroller`: Componente reusable AppApphorizontalscroller para la capa UI compartida del proyecto.
...
- Nuevo componente compartido en `src/app/Components/UI/AppApphorizontalscroller/`.
