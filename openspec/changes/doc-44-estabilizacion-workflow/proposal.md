...
ESTABILIZACION-WORKFLOW. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-44.
...
### New Capabilities
- `estabilizacion-workflow`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
