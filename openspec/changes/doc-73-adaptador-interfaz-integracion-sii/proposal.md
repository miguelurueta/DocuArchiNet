...
ADAPTADOR-INTERFAZ-INTEGRACION-SII. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-73.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: ADAPTADOR, INTEGRACION, INTERFAZ, SII

## Capabilities

### New Capabilities
- `adaptador-interfaz-integracion-sii`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
