...
ADAPTADOR-SII-ASMX. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-55.
...
- Tipo: Tarea
- Prioridad: Medium
- Labels: ADPATADOR, ASMX, SII

## Capabilities

### New Capabilities
- `adaptador-sii-asmx`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
