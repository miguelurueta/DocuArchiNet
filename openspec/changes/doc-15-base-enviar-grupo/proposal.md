...
BASE-ENVIAR-GRUPO. Ver detalle funcional completo del ticket en la seccion Jira Details.

## What Changes

- Se genera automaticamente una propuesta OpenSpec basada en el issue DOC-15.
...
### New Capabilities
- `base-enviar-grupo`: Capacidad derivada del ticket Jira para continuar el refinamiento funcional en OpenSpec.
