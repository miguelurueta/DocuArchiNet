...
var _bLinux = (_platform.indexOf('linux')>=0);
...
if(_bLinux)
{
    ...
    document.write('<li class="D_menu_item" style="width:50%" title="Includes Source Code of Current Page"><a target="_blank" href="http://www.dynamsoft.com/demo/OCR/OCRProServerSide.aspx">OCR Professional</a></li></ul></div></div>');
}
else if(_bMac || _bPluginEdition || _bSafari)
{	
    if (paraValue == 0)
    ...
    document.write('<li class="D_menu_item" style="width:25%" title="Includes Source Code of Current Page"><a target="_blank" href="http://www.dynamsoft.com/demo/OCR/OCRProServerSide.aspx">OCR Professional</a></li></ul></div></div>');
}
else
{
    if (paraValue == 0)
        document.write('<li class="D_menu_item_select" style="width:20%"><a href="online_demo_scan.aspx">Document Scanning</a></li>');
    else
        document.write('<li class="D_menu_item" style="width:20%"><a href="online_demo_scan.aspx">Document Scanning</a></li>');
        
    if(paraValue == 1)
        document.write('<li class="D_menu_item_select" style="width:20%"><a href="online_demo_scan_Webcam.aspx">Webcam Capture</a></li>');
    else
        document.write('<li class="D_menu_item" style="width:20%"><a href="online_demo_scan_Webcam.aspx">Webcam Capture</a></li>');
      
    if(paraValue == 2)  
        document.write('<li class="D_menu_item_select" style="width:20%"><a href="online_demo_scan_Barcode.aspx">Read Barcode</a></li>');
    else
        document.write('<li class="D_menu_item" style="width:20%"><a href="online_demo_scan_Barcode.aspx">Read Barcode</a></li>');

    if(paraValue == 3)  
        document.write('<li class="D_menu_item_select" style="width:20%"><a href="online_scan_pdf_rasterizer.aspx">PDF Rasterizer</a></li>');
    else
        document.write('<li class="D_menu_item" style="width:20%"><a href="online_scan_pdf_rasterizer.aspx">PDF Rasterizer</a></li>');
    document.write('<li class="D_menu_item" style="width:20%" title="Includes Source Code of Current Page"><a target="_blank" href="http://www.dynamsoft.com/demo/OCR/OCRProServerSide.aspx">OCR Professional</a></li></ul></div></div>');
}
/*document.write('<li class="D_menu_item" style="width:20%" title="Includes Source Code of Current Page"><a target="_blank" href="http://www.dynamsoft.com/demo/OCR/OCRProServerSide.aspx">OCR Professional</a></li></ul></div></div>');*/
