<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormDaVisorDocuarchi.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormDaVisorDocuarchi" %>
             ...
             <div class="collapse navbar-collapse   pb-1 pt-0" id="navbarNavDropdown">
                 <div class="nav  ">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel_drows_bot" runat="server"
                                    ...
                                    <div class="nav-item_ active active_azul">
                                        <a class="nav-link active_azul" style="color: white; font-family: Arial; text-decoration: none; font-weight: 600" title="Información imagen (tecla E)" href="#" onclick="activa_boton_client_server('ImageButtoninfo')"><i style="color: white" class="far fa-info-circle fa-1x"></i></a>                          
                                    </div>
                                    <div class="nav-item_ active active_azul">
                                          <a id="id_indice_wf_pdf_draw" class="nav-link" style="color: white; font-family: Arial; text-decoration: none; font-weight: 600" title="Ver meta datos de documento" href="#" onclick="event_click_indice_meta_dato(event,this);"><i style="color: white" class="fas fa-file-invoice"></i></a>
                                     </div>
                                    <div class="nav-item_ active active_azul">
             ...
             <div style="display: none">
                 <asp:UpdatePanel ID="UpdatePanelButon" runat="server"
                     ...
                     <ContentTemplate>
                         ...
                         <a style="margin-left: 2px; margin: 2px; width: auto; color: black; font-family: Arial; font-size: 12px; text-decoration: none; font-weight: 600" title="Rotar 90 grados" href="#" onclick="activa_boton_client_server('ImageRotate45')"><i style="width: 23px; height: 23px" class="far fa-redo fa-2x"></i>90'</a>
                         ...
                         <a style="margin-left: 2px; margin: 2px; width: auto; color: black; font-family: Arial; font-size: 12px; text-decoration: none; font-weight: 600" title="Rotar 180 grados" href="#" onclick="activa_boton_client_server('ImageRotate180')"><i style="width: 23px; height: 23px" class="far fa-redo fa-2x"></i>180'</a>
                         ...
                         <a style="margin-left: 2px; margin: 2px; width: auto; color: black; font-family: Arial; font-size: 12px; text-decoration: none; font-weight: 600" title="Rotar 270 grados" href="#" onclick="activa_boton_client_server('ImageRotate270')"><i style="width: 23px; height: 23px" class="far fa-redo fa-2x"></i>270'</a>
                         ...
                         <asp:ImageButton ID="ImageButtoninfo" runat="server" ToolTip="Información Documento" ImageUrl="../Docuarchi/imagenes/infoimagen.png" Style="display: none" />
                         <asp:ImageButton ID="ImageButtonindice" runat="server" ToolTip="Visualiza indice documento" ImageUrl="../Docuarchi/imagenes/indice222.png" Style="display: none" />
                         <asp:ImageButton ID="ImageButton_ir_pagina" runat="server" ToolTip="Ir a página" ImageUrl="../Docuarchi/imagenes/busca_pagina.png" Style="display: none" />
