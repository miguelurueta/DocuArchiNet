...
function auto_zise_popup_validacion_radicados() {
    try {
        ...
        heigconetedor = document.getElementById("Button_procesar_envio").clientHeight + $("#inferior_bajo_boton").height() + 5;
        ...
        alert(ex.message + " función java uto_zise_popup_validacion_radicados")
    }
}
function auto_zise_popup_plantilla_validacion() {
    try {
        ...
        $('#Panel_valiacion_plantilla').css("height", (espacio_iframe - 30) + "px");
        $('#Iframe_validacion_plantilla_').css("height", (espacio_iframe - 35) + "px");
        document.getElementById("Hidden_height").value = espacio_iframe - 35;
...
function auto_size_popup_procesa_tramite() {
    ...
    $('#contenido_procesa_tramite_envio').css("height", (espacio_iframe - 55) + "px");
        ...
        $("#GridView_val_radicacion tr[id=" + $("#hdnEmailID_VAL").val() + "]").each(function () {
            for (i = 0; i <= ref_values_campos.length - 1 ; i++) {
                ...
                if (idex != -1) {
                    ...
                    if ($(this)[0].cells[idex].children.length > 0) {
                        $(this)[0].cells[idex].children[0].innerText = text;
                        $(this)[0].cells[idex].children[0].style.overflow = "auto";
                    } else {
                        $(this)[0].cells[idex].innerText = "";
                        var heade = $("#GridView_val_radicacionCopy th");
...
function eliminar_fila_data_gred() {
    try {
        ...
        if (document.forms.item(0).id == "form1") {
            document.getElementById("titulo_label_val_radicacion").innerHTML = "Se encontraron " + chid + " registro(s) de guías ";
        } else {
            document.getElementById("titulo_label_val_radicacion").innerHTML = "Se encontraron " + chid + " registro(s) de guías ";
        }
    }
