...
Public Class WebFormDiagramaEstadoFlujoTrabajo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            Result = Refclas.Lista_flujo_trabajo_tarea_worflow_grafico(Me.Label_nombre_flujo_trabjo, _
                                                                       Me.diagramView, _
    ...
    Protected Sub HiddenField_value_selecion_ValueChanged(sender As Object, e As EventArgs) Handles HiddenField_value_selecion.ValueChanged
    ...
    Private Sub DropDownList_vistas_disponibles_workflow_TextChanged(sender As Object, e As EventArgs) Handles DropDownList_vistas_disponibles_workflow.TextChanged
        ...
        Try
            Dim Nombre_flujo_trabajo As String = ""
            If Me.DropDownList_vistas_disponibles_workflow.Text = "Estado del flujo de trabajo" Then
                Result = Refclas.Lista_flujo_trabajo_tarea_worflow_grafico(Me.Label_nombre_flujo_trabjo, _
                                                                           Me.diagramView, _
                                                                           Me.UpdatePanel_diagran_view, _
                                                                           Me.CheckBox_Grid_alineamiento)
                ...
                End If
            End If
            If Me.DropDownList_vistas_disponibles_workflow.Text = "Trazabilidad del flujo de trabajo" Then
                Result = Refclas.Diagrama_trazabilidad_flujo_trabajo(Session.Item("DR_ID_TAREA_FLUJO_TRABAJO"), _
                                                                     Me.diagramView, _
                                                                     Me.UpdatePanel_diagran_view, _
                                                                     Me.CheckBox_Grid_alineamiento, _
