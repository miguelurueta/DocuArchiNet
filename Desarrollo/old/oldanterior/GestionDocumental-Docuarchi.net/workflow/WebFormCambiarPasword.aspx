<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormCambiarPasword.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormCambiarPasword" %>
...
<body>
    ...
    <div>
       <div id="superior" style="width:100%; height:30%;background-color: #E7EDF5; margin-bottom:10px" >
             <asp:Label ID="Label5" runat="server" Text="Cambiar contraseña workflow" Style="font-family:Arial; font-size:20px;color:black"></asp:Label>
         </div>
