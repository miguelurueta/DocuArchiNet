<%@ Page Title="Reportes de gestion" Language="vb" AutoEventWireup="false" CodeBehind="WebFormRadicadoExterno.aspx.vb" MasterPageFile="~/Masterpage/Principal.Master" Inherits="GestionDocumental_Docuarchi.net.WebFormRadicadoExterno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
   ...
   <script src="../js/jquery.contextMenu.js" type="text/javascript"></script>
    <script src="../js/radicacion/WebFormRadicadoExterno.js"></script>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlacenter" runat="server">
        <form id="form1" runat="server">
            <div>
                <input id="Hidden_tipo_contenido" type="hidden" value="" runat="server"/>
                ...
                <iframe id="ifrm_ds_" runat="server"
                    ...
                    frameborder="0" scrolling="no" src="../radicador/WebFormReportesRadicacion.aspx">
