...
(function(D) {
    function SWebTwain() {
        ...
        swt._iWidth = 98;        // The width of the main control.
        swt._iHeight = 88;       // The height of the main control.
    ...
    SWebTwain.prototype._createControl = function() {
        ...
        var objString = "<div id ='" + this._strDWTInnerContainerID + "' style='width:" + this._iWidth + "%; height:" + this._iHeight + "%;'>";
        ...
        if (Dynamsoft.Env._bInIE) {
            ...
            objString += "<object id='" + this._strObjectName + "' style='width:" + this._iWidth + "%;height:" + this._iHeight + "%'";
        ...
        // For non-IE, render the embed object
            ...
            objString += "<embed id='" + this._strObjectName + "' style='width:" + this._iWidth + "%;height:" + this._iHeight + "%' type='" + D.DWTProduct._strMIMETYPE + "'";
        ...
        objString += "</div><div id='" + this._strDWTNonInstallInnerContainerID + "' style='width: " + this._iWidth + "%;'></div>";
