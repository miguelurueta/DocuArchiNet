...
function auto_size_registra_radicado() {
    try {
        ...
        var heigconetedor = (espacio_iframe - 50) - (((espacio_iframe - 50) * 5) / 100);
        $("#contenido_registro").css("height", (heigconetedor) + "px");
        heigconetedor = (espacio_iframe - 50) - (((espacio_iframe - 50) * 90) / 100);
        $("#contendor_principal").css("height", (espacio_iframe - 50) + "px");
        document.getElementById("contenido_registro").style.width = document.getElementById("TextBox_NOMBRE_RAZON_SOCIAL").style.width + "px";

    }
    catch (err) {
        alert(err.message + " Funcion auto_size_registra_radicado");
    }
}
function auto_zise_popup_plantilla_validacion() {
    try {
        ...
        $('#Panel_valiacion_plantilla').css("width", (with_frame -10) + "px");
        $('#Panel_valiacion_plantilla').css("height", (espacio_iframe - 40) + "px");
        $('#Iframe_validacion_plantilla_').css("height", (espacio_iframe - 40) + "px");
        $('#Iframe_validacion_plantilla_').css("width", (with_frame - 10) + "px");
        document.getElementById("Hidden_height").value = espacio_iframe - 40;
        document.getElementById("Hidden_width").value = with_frame - 10;
    }
    catch (err) {
...
function onclik_asignacion() { document.getElementById("Button_Asigana_datos_validacion_edicion_manual").click(); }
