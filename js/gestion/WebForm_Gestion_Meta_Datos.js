...
function auto_zise_gestion_meta_datos() {
    try {
        var espacio_iframe = 420;
        var hidenpadre = 0;
        var with_frame = 420;
        ...
        $('#content_meta_data').css("height", ((espacio_iframe - 30) - document.getElementById("content_boton").clientHeight) + "px");
    }
    catch (err) {
        alert(err.message + " funcion auto_zise_gestion_meta_datos " + err.message);
    }
}