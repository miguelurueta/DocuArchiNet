...
Namespace Samples.AspNet.Membership
  ...
  Public NotInheritable Class OdbcMembershipProvider
    ...
    Public Overrides Sub Initialize(name As String, config As NameValueCollection)
      ...
      Dim temp_format As String = GetConfigValue(config("passwordFormat"), "Hashed").Trim()

      Select Case temp_format.ToLowerInvariant()
        Case "hashed"
        ...
        Case Else
          Throw New ProviderException("Password format not supported: " & temp_format)
      End Select
      ...
      Dim connectionStringName As String = GetConfigValue(config("connectionStringName"), "OdbcServices").Trim()
    ...
    Public Overrides Function ChangePasswordQuestionAndAnswer(username As String, _
      ...
      Dim conn As OdbcConnection = New OdbcConnection(connectionString)
            ...
            Return False
        End Function
        Public Function Formatea_Fecha_Almacenamiento(ByRef date1al As String) As String
            '****************************************
            ...
            Try
                ...
                Else
                    date1al = ""
                    Formatea_Fecha_Almacenamiento = "#Error formatenado fecha"
                    Exit Function
                End If
                Formatea_Fecha_Almacenamiento = "YES"
            Catch ex As Exception
                Formatea_Fecha_Almacenamiento = ex.ToString
            End Try
        End Function
        ...
        ByVal providerUserKey As Object, _
            ...
            If u Is Nothing Then
                ...
                Result = Formatea_Fecha_Almacenamiento(date1al)
                Dim createDate As String = date1al
                ...
                Dim cmd As OdbcCommand = New OdbcCommand("INSERT INTO Users " & _
                       ...
                       " Values( '" & _
                       username & "','" & EncodePassword(password) & "','" & _
                       "maum_maum@hotmail.com','" & "gestor','" & "gestor','" & 1 & "'," & _
                       "''" & ",'" & createDate & "','" & createDate & "','" & createDate & "','" & pApplicationName & _
                       "','" & 0 & "','" & createDate & "',0" & ",'" & createDate & "',0" & ",'" & createDate & "')", conn)

                '?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", conn)

                'Dim pkd As Object = providerUserKey
                'Dim Usernam As String =
                'cmd.Parameters.Add("@PKID", OdbcType.UniqueIdentifier).Value = providerUserKey
                'cmd.Parameters.Add("@Username", OdbcType.VarChar, 255).Value = username
                'cmd.Parameters.Add("@Password", OdbcType.VarChar, 255).Value = EncodePassword(password)
                'cmd.Parameters.Add("@Email", OdbcType.VarChar, 128).Value = "maum_maum@hotmail.com"
                'cmd.Parameters.Add("@PasswordQuestion", OdbcType.VarChar, 255).Value = "gestor"
                'cmd.Parameters.Add("@PasswordAnswer", OdbcType.VarChar, 255).Value = EncodePassword("gestor")
    ...
    Public Overrides Function GetUserNameByEmail(email As String) As String    
      Dim conn As OdbcConnection = New OdbcConnection(connectionString)
            ...
            Try
                conn.Open()
                If Not cmd.ExecuteScalar().ToString() Is Nothing Then
            ...
            Try
                ...
                If CheckPassword(password, pwd) Then
                    If isApproved Then
                        ...
                        updateCmd.Parameters.Add("@LastLoginDate", OdbcType.Date).Value = DateTime.Now
                        updateCmd.Parameters.Add("@Username", OdbcType.VarChar, 255).Value = username
                        updateCmd.Parameters.Add("@ApplicationName", OdbcType.VarChar, 255).Value = pApplicationName
    ...
    '
        ...
        Private Function EncodePassword(ByVal password As String) As String
            Dim ncodedPassword As String = password
            Dim refpas As String = password
            Dim objet
            Dim resbo
            Select Case PasswordFormat
                ...
                Case MembershipPasswordFormat.Hashed
                    ...
                    objet = Encoding.Unicode.GetBytes(refpas)
                    resbo = Convert.ToBase64String(objet)
                    ncodedPassword = resbo
                    'encodedPassword = Convert.ToBase64String(hash.ComputeHash(Encoding.Unicode.GetBytes(password)))
                Case Else
                    Throw New ProviderException("Unsupported password format.")
            End Select

            EncodePassword = ncodedPassword
            Exit Function
        End Function
