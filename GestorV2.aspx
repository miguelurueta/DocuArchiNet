<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GestorV2.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.GestorV2" %>
    ...
    <div class="contenedor">
     <div class="formulario">
         <form action="#">
             ...
             <div class="input-contenedor"><!--Este es el input del login usuario-->
                 <i class="fas fa-user"></i>
                 <input type="text" placeholder=" " required/>
                 <label  for="#">Usuario</label>
             </div>
             <div class="input-contenedor"><!--Este es el input de contraseña-->
