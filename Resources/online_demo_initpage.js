...
function pageonload() {    
    ...
    twainsource = document.getElementById("source");
    if (twainsource) {
...
function SaveScanSettings() {
    ...
    if (DWObject) {
            ...
            document.cookie = "IfFeederEnabled=" + document.getElementById("ADF").checked + ";expires=" + date.toGMTString();
            document.cookie = "IfDuplexEnabled=" + document.getElementById("Duplex").checked + ";expires=" + date.toGMTString();*/
            var i;
            if (ID_RA_CONFIG_DIG == -1) {
                for (i = 0; i < 3; i++) {
                    if (document.getElementsByName("PixelType").item(i).checked == true)
                        document.cookie = "PixelType=" + i + ";expires=" + date.toGMTString();
                }
                for (i = 0; i < 4; i++) {
                    if (document.getElementsByName("TypeFormato").item(i).checked == true)
                        document.cookie = "TypeFormato=" + i + ";expires=" + date.toGMTString();
                }
            }
            /*document.cookie = "Resolution=" + document.getElementById("Resolution").value + ";expires=" + date.toGMTString();
            document.cookie = "IfRadio_pag_blankEnabled=" + document.getElementById("Radio_pag_blank").checked + ";expires=" + date.toGMTString();
            document.cookie = "Ifdes_kewEnabled=" + document.getElementById("des_kew").checked + ";expires=" + date.toGMTString();
            document.cookie = "IfAutomaticBorderDetection=" + document.getElementById("border_detect").checked + ";expires=" + date.toGMTString();*/
            
        
        var source_scan;
       
        if (document.getElementById("source").options.length > 0) {
            if (document.getElementById("source").options[document.getElementById("source").selectedIndex].text) {
                source_scan = document.getElementById("source").options[document.getElementById("source").selectedIndex].text;
            }
            document.cookie = "driver_scan=" + source_scan + ";expires=" + date.toGMTString();
        }
       
    }
    if (DWObject) {
        if (ID_CONFIG_DIGITALIZACION_DA !== -1) {
            var estao_consume_service = 0
            if ((document.getElementById("ShowUI").checked == true && CONTROLADOR_PROPIO_CONFIGURACION_DA == 0) || (document.getElementById("ShowUI").checked == false && CONTROLADOR_PROPIO_CONFIGURACION_DA == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("ADF").checked == true && ADF_CONFIGURACION == 0) || (document.getElementById("ADF").checked == false && ADF_CONFIGURACION == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("Duplex").checked == true && DUPLEX_CONFIGURACION_DA == 0) || (document.getElementById("Duplex").checked == false && DUPLEX_CONFIGURACION_DA == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("Radio_pag_blank").checked == true && DESC_PAG_BLANCO_CONFIGURACION_DA == 0) || (document.getElementById("Radio_pag_blank").checked == false && DESC_PAG_BLANCO_CONFIGURACION_DA == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("des_kew").checked == true && DESK_CONFIGURACION == 0) || (document.getElementById("des_kew").checked == false && DESK_CONFIGURACION == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("border_detect").checked == true && DETECT_BORDE_CONFIGURACION_DA == 0) || (document.getElementById("border_detect").checked == false && DETECT_BORDE_CONFIGURACION_DA == 1)) {
                estao_consume_service = 1;
            }
            if ((document.getElementById("rigt").style.display == "flex" && VISTA_CONFIGURACION_ESCANER_DA == 0) || (document.getElementById("rigt").style.display == "none" && VISTA_CONFIGURACION_ESCANER_DA == 1)) {
                estao_consume_service = 1;
            }
            if (ESTADO_TUMB !== TUMBAIL_VISOR_DA) {
                estao_consume_service = 1;
            }
            if (estao_consume_service == 1) {
                estao_consume_service = 0;
                if (document.getElementById("ShowUI").checked == true) {
                    CONTROLADOR_PROPIO_CONFIGURACION_DA = 1;
                } else {
                    CONTROLADOR_PROPIO_CONFIGURACION_DA = 0;
                }
                ...
                if (document.getElementById("Duplex").checked == true) {
                    DUPLEX_CONFIGURACION_DA = 1;
                } else {
                    DUPLEX_CONFIGURACION_DA = 0;
                }
                if (document.getElementById("Radio_pag_blank").checked == true) {
                    DESC_PAG_BLANCO_CONFIGURACION_DA = 1;
                } else {
                    DESC_PAG_BLANCO_CONFIGURACION_DA = 0;
                }
                if (document.getElementById("des_kew").checked == true) {
                    DESK_CONFIGURACION = 1;
                } else {
                    DESK_CONFIGURACION = 0;
                }
                if (document.getElementById("border_detect").checked == true) {
                    DETECT_BORDE_CONFIGURACION_DA = 1;
                } else {
                    DETECT_BORDE_CONFIGURACION_DA = 0;
                }
                if (document.getElementById("rigt").style.display == "flex") {
                    VISTA_CONFIGURACION_ESCANER_DA = 1;
                } else {
                    VISTA_CONFIGURACION_ESCANER_DA = 0;
                }
                if (ESTADO_TUMB == 1) {
                    TUMBAIL_VISOR_DA = 1;
                } else {
                ...
                ITEMS_DATOS_CONFIG_INTERFACE_DIG = new Array();
                ITEMS_DATOS_CONFIG_INTERFACE_DIG.push({
                    "controlador_propio_configuracion": CONTROLADOR_PROPIO_CONFIGURACION_DA, "adf_configuracion": ADF_CONFIGURACION,
                    "detect_borde_configuracion": DETECT_BORDE_CONFIGURACION_DA, "desk_configuracion": DESK_CONFIGURACION,
                    "desc_pag_blanco_configuracion": DESC_PAG_BLANCO_CONFIGURACION_DA, "duplex_configuracion": DUPLEX_CONFIGURACION_DA,
                    "vista_configuracion_escaner": VISTA_CONFIGURACION_ESCANER_DA, "tumbail_visor": TUMBAIL_VISOR_DA, "zoon_visor": ZOON_VISOR_DA,
                    "id_config_digitalizacion": ID_CONFIG_DIGITALIZACION_DA
                });
                Service_actualiza_estructura_interface_digitalizacion();
            }
        }
    }
}
function LoadScanSettings() {
    var IfShowUI;
    if (CONTROLADOR_PROPIO_CONFIGURACION_DA == 1) {
        IfShowUI = "true";
    } else {
        IfShowUI = "false";
    }
    ...
    var IfFeederEnabled;
    if (ADF_CONFIGURACION == 1) {
        IfFeederEnabled = "true";
    } else {
        IfFeederEnabled = "false";
    }
    document.getElementById("ADF").checked = (IfFeederEnabled == "true");
    var IfDuplexEnabled;
    if (DUPLEX_CONFIGURACION_DA == 1) {
        IfDuplexEnabled = "true";
    } else {
        IfDuplexEnabled = "false";
    }
    document.getElementById("Duplex").checked = (IfDuplexEnabled == "true");

    var IfRadio_pag_blankEnabled;
    if (DESC_PAG_BLANCO_CONFIGURACION_DA == 1) {
        IfRadio_pag_blankEnabled = "true";
    } else {
        IfRadio_pag_blankEnabled = "false";
    }
    document.getElementById("Radio_pag_blank").checked = (IfRadio_pag_blankEnabled == "true");
    var Ifdes_kewEnabled;
    if (DESK_CONFIGURACION == 1) {
        Ifdes_kewEnabled = "true";
    } else {
        Ifdes_kewEnabled = "false";
    }
    document.getElementById("des_kew").checked = (Ifdes_kewEnabled == "true");

    var IfAutomaticBorderDetection;
    if (DETECT_BORDE_CONFIGURACION_DA == 1) {
        IfAutomaticBorderDetection = "true";
    } else {
        IfAutomaticBorderDetection = "false";
    }
    document.getElementById("border_detect").checked = (IfAutomaticBorderDetection == "true");
    ...
    if (strCookie == "")
        ...
        for (var i = 0; i < document.getElementById("Resolution").options.length; i++) {
            if (document.getElementById("Resolution").options[i].value == RESOLUCION_DIG) {
                document.getElementById("Resolution").options[i].selected = true;
                break;
            }
        }
        ...
        for (var i = 0; i < arrCookie.length; i++) {
            var arr = arrCookie[i].split("=");
            if ("driver_scan" == arr[0]) {
                driver_scan_ = arr[1];
                break;
            }
        }
        for (var i = 0; i < document.getElementById("source").options.length; i++) {
            if (document.getElementById("source").options[i].text == driver_scan_) {
        ...
        if (ID_RA_CONFIG_DIG == -1) {
            ...
            document.getElementsByName("PixelType").item(parseInt(PixelType)).checked = true;
            var TypeFormato;
            for (var i = 0; i < arrCookie.length; i++) {
                var arr = arrCookie[i].split("=");
                if ("TypeFormato" == arr[0]) {
                    PixelType = arr[1];
                    break;
                }
            }
...
function InitMessageBody() {
    ...
    if (MessageBody) {
        var ObjString = "<div><p>Platform & Browser Support: </p>Internet Explorer 6 or above (32 bit/64 bit), any version of Chrome (32 bit/64 bit), any version of Firefox on Windows; Safari, Chrome and Firefox on Mac OS X 10.6 or later; Chrome and Firefox v27 or above (64 bit) on Ubuntu 10-16, Debian 8, or Fedora 19-24";
        ObjString += ".</div>";
    ...
    if (DWObject) {
        ...
        if (DWObject.ErrorCode == 0) {			
			...
			DWObject.RegisterEvent('OnMouseDoubleClick', function (sImageIndex) {
			    pagina_entera(sImageIndex);
			});
			
			
			DWObject.RegisterEvent('OnTopImageInTheViewChanged', function (sImageIndex) {
			    document.getElementById('Paginador').innerHTML = (sImageIndex + 1) + " de " + DWObject.HowManyImagesInBuffer;
		    });
...
//               webcamsource.options[0].selected = true; 
            ...
            if(btnScan)
            {
                if (vCount == 0)
					...
					document.getElementById("btnScan").style.backgroundColor = "#fe8e14";
            ...
            if(btnWebcam)
            {
                if (vWebcamCount == 0)
                    ...
                    document.getElementById("btnWebcam").style.color = "#fff";
					document.getElementById("btnWebcam").style.backgroundColor = "#fe8e14";
					document.getElementById("btnWebcam").style.cursor = "pointer";
                }
            }
