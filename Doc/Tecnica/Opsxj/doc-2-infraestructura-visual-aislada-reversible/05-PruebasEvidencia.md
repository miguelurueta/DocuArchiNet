...
- Con esta toma quedan evidenciados el estado deshabilitado natural, el documento seleccionado, el menú contextual y el viewport de 375 px. La tarea 6.6 sigue pendiente únicamente de asociar todas las tomas al commit o versión de build realmente desplegada; `4dba10b` continúa excluido porque no contiene los cambios DOC-2 sin commit.
