Public Class WebFormGaEditarExpediente
    ...
    Private Sub Button_lista_ayuda_expediente_Click(sender As Object, e As EventArgs) Handles Button_lista_ayuda_expediente.Click
        ...
        Try
            ...
            If Result <> "YES" Then
                classcrip.Showscripman_menu(Result, update_panel_controles, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            End If
    ...
    Private Sub Button_selecion_organigrama_Click(sender As Object, e As EventArgs) Handles Button_selecion_organigrama.Click
        ...
        Try
            ...
            Result = Refclas.Seleccion_organigrama_editar(Me.DropDownListorganigrama.Text, _
            ...
            End If
        Catch ex As Exception
            classcrip.Showscripman(ex.Message, Me.update_panel_controles)
        End Try
    End Sub
    ...
    Private Sub WebFormGaEditarExpediente_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        If Page.IsPostBack = False Then
            ...
            Session.Item("SESIONITERCAMBIOEXPEDIENTE_ASIG") = Session.Item("SESIONITERCAMBIOEXPEDIENTE")
            ...
            Result = refclascexpediente.Asigna_datos_interface_expediente(update_panel_controles, _
                                                                          hdnEmailID, _
                                                                          Hidden_id_empresa)
            If Result <> "YES" Then
    ...
    Private Sub ButtonRestaurar_Click(sender As Object, e As EventArgs) Handles ButtonRestaurar.Click
        ...
        Try
            ...
            Result = refclascexpediente.Asigna_datos_interface_expediente(update_panel_controles, _
                                                                          ...
                                                                          Hidden_id_empresa)
            If Result <> "YES" Then
                reclasjava.Showscripman_menu(Result, Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            End If
        Catch ex As Exception
            reclasjava.Showscripman_menu(ex.Message, Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
        End Try
    End Sub
    ...
    Private Sub ButtonAceptar_Click(sender As Object, e As EventArgs) Handles ButtonAceptar.Click
        ...
        Try
            Dim Result As String = ""
            Dim Refclas As New ClassGaExpediente
            Dim split() As String = (HttpContext.Current.Session.Item("SESIONITERCAMBIOEXPEDIENTE_ASIG").ToString.Split("|"))
            If split(2) = "EDITAR" Then
                ...
                Else
                    If HttpContext.Current.Session.Item("GA_EDITA_EXPEDIENTES") = 0 Then
                        scripjava.Showscripman_menu("Usuario sin permisos para editar expediente", Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                        Exit Sub
                    End If
            ...
            End If
            Result = Refclas.Actualiza_Expediente_Conservacion(Session.Item("GA_IDUSUARIOGESTION"), _
                                                               ...
                                                               Me.DropDownListorganigrama.Text, _
                                                               Me.DropDownListArea.Text, _
                                                               serie_documental, _
                                                               sub_serie_documental, _
                                                               hdnEmailID.Value, _
                                                               HttpContext.Current.Session.Item("GA_LOGINUSUARIOGESTION"), _
                                                               HttpContext.Current.Session.Item("ip_host_name"), _
                                                               0, _
                                                               id_tipo_expediente, _
                                                               Me.TextBoxNUMERO_DIGITALIZADO_CONTENIDO.Text, _
                                                               Me.TextBoxNUMERO_FOLIOS_CONTENIDOS.Text, _
                                                               Me.TextBoxNUMERO_ELECTRONICO_CONTENIDO.Text, _
                                                               Me.TextBoxASUNTO_EXPEDIENTE.Text, _
                                                               0, _
                                                               Me.DropDownList_tipo_unidad_conservacion.Text, _
                                                               Me.DropDownList_tipo_unidad_conservacion.Text, _
                                                               Me.TextBoxOBSERVACION_EXPEDIENTE.Text, _
                                                               Me.DropDownListNOMBRE_TIPO_UNIDAD_DOCUMENTAL.Text, _
                                                               DropDownListsub_seccion.Text, _
                                                               ciclo_archivo, _
                                                               Me.DropDownListNOMBRE_FONDO.Text, _
                                                               Me.TextBoxNOMBRE_PERSONA_EXPEDIENTE.Text, _
                                                               Me.TextBoxIDENTIFICACION_PERSONA_EXPEDIENTE.Text, _
                                                               Me.TextBoxNOMBRE_RESPONSABLE_EXPEDIENTE.Text, _
                                                               Me.TextBoxIDENFICACION_RESPONSABLE_EXPEDIENTE.Text, _
                                                               id_istrumento, _
                                                               requiere_unida_conservacion_fisica, _
                                                               split(2))
            If Result <> "YES" Then
                scripjava.Showscripman_menu(Result, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            End If       
            Session.Item("SESIONITERCAMBIOEXPEDIENTE") = "ACTUALIZA_EXPDIENTE_VENTANA_WEB"
        Catch ex As Exception
            scripjava.Showscripman_menu(ex.Message, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
        End Try
    End Sub

    Private Sub ButtonAgregaVolumen_Click(sender As Object, e As EventArgs) Handles ButtonAgregaVolumen.Click
        Dim scripjava As New Classscrripjava
        Try
            Dim Result As String = ""
            Dim Refclas As New ClassGaExpediente
            ...
            Result = Refclas.SolicitaDatosEstructuraExpediente(Me.hdnEmailID.Value.ToString.Trim,
                                                               estru_expediente)
            If Result <> "YES" Then
                scripjava.Showscripman_menu(Result, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            ...
            If Result <> "YES" Then
                ...
                Exit Sub
            End If
            'Dim id_tipo_unidad_conservacion As Integer = -1
            'If requiere_unida_conservacion_fisica = 1 Then
            '    If Me.DropDownList_tipo_unidad_conservacion.Text = "" Then
            '        scripjava.Showscripman_menu("Debe informar el tipo de unidad conservación", Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
            '        Exit Sub
            '    End If
            '    '------Retorna id tipo unidad de conservación
            '    Dim refclasunidad As New ClassUnidadConservacion
            '    Result = refclasunidad.Retorna_id_tipo_unidad_conservacion_expediente(Me.DropDownList_tipo_unidad_conservacion.Text, id_tipo_unidad_conservacion, 1)
            '    If Result <> "YES" Then
            '        scripjava.Showscripman_menu(Result, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
            '        Exit Sub
            '    End If
            'Else
            '    id_tipo_unidad_conservacion = -1
            'End If
            'Dim id_expediente As Integer = 0
            ...
            If Not Me.DropDownListNOMBRE_CICLO_ARCHIVO.SelectedItem Is Nothing Then
                ciclo_archivo = Me.DropDownListNOMBRE_CICLO_ARCHIVO.SelectedItem.Text
            End If
            Result = Refclas.Registrar_Expediente_Volumen(Session.Item("GA_IDUSUARIOGESTION"), Me.TextBoxCodigoManual.Text, 1, Me.Hidden_id_empresa.Value,
              Me.TextBoxFECHA_EXTREMA_INICIAL.Text, Me.TextBoxFECHA_EXTREMA_FINAL.Text,
             Me.TextBoxRANGO_EXTREMO_INICIAL.Text, Me.TextBoxRANGO_EXTREMO_FINAL.Text,
             Me.TextBoxTEMA_EXPEDIENTE.Text, Me.DropDownListorganigrama.Text,
             Me.DropDownListArea.Text, serie_documental, sub_serie_documental, id_tipo_expediente,
             Me.TextBoxNUMERO_DIGITALIZADO_CONTENIDO.Text.Trim,
             Me.TextBoxNUMERO_FOLIOS_CONTENIDOS.Text.Trim, Me.TextBoxNUMERO_ELECTRONICO_CONTENIDO.Text.Trim,
             Me.TextBoxASUNTO_EXPEDIENTE.Text.Trim, estru_expediente(0).ID_EXPEDIENTE, estru_expediente(0).CODIGO_UNICO,
             Me.DropDownList_tipo_unidad_conservacion.Text, id_expediente, Me.TextBoxOBSERVACION_EXPEDIENTE.Text,
             Me.DropDownListNOMBRE_TIPO_UNIDAD_DOCUMENTAL.Text, Me.DropDownListsub_seccion.Text, option_obliga_archivo_unidad, Hidden_tipo_unidad.Value,
             id_unidad_contenedora, requiere_unida_conservacion_fisica, ciclo_archivo, Me.DropDownListNOMBRE_FONDO.Text,
             Me.TextBoxNOMBRE_PERSONA_EXPEDIENTE.Text, Me.TextBoxIDENTIFICACION_PERSONA_EXPEDIENTE.Text, Me.TextBoxNOMBRE_RESPONSABLE_EXPEDIENTE.Text,
             Me.TextBoxIDENFICACION_RESPONSABLE_EXPEDIENTE.Text, id_istrumento)
            If Result <> "YES" Then
                scripjava.Showscripman_menu(Result, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            End If
            ...
            Result = Refclas.Genera_rotulo_Eexpediente_pdf(id_expediente, Session.Item("GA_IDEMPRESA"), nombre_plantilla_impresion, ruta_archivo)
            If Result <> "YES" Then
                scripjava.Showscripman_menu("se registro el expediente, pero no se genero el rotulo " & Result, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
                Exit Sub
            Else
            ...
            End If
            Session.Item("SESIONITERCAMBIOEXPEDIENTE") = "AGREGO_EXPDIENTE_VOLUMEN_WEB"
        Catch ex As Exception
            scripjava.Showscripman_menu(ex.Message, Me.Updatepanel_botones, "ModalPopupExtender_mensaje_personalizado")
        End Try
    End Sub
