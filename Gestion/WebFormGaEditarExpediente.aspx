<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebFormGaEditarExpediente.aspx.vb" Inherits="GestionDocumental_Docuarchi.net.WebFormGaEditarExpediente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   ...
   <script src="../js/ui/jquery.ui.core.js" type="text/javascript"></script>
    ...
    <script src="../js/gestion/WebFormGaEditarExpediente.js"></script>
...
<body style="background-color:transparent">
    <form id="formeditarexepediente" runat="server">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function CheckStatus(sender, args) {
                ...
                if (elment_postbak.id == "Button_activa_archivar_unidad") {
                    ...
                    alert("Inconsistencia función CheckStatus form WebFormGaEditarExpediente " + ex.message)
      ...
      <div id="contenedorcontroles" style="height:100%; width:100%; background-color:white" Class="modal_content_general">
          <div id="titulo"   class="modal_title_superior_ modal-header">
              <asp:Label ID="Label_estado" runat="server" Text=""  CssClass="modal-title d-inline ml-1 mt-1" ></asp:Label>
              <asp:Label ID="Labeltitulo" runat="server" Text="Editar unidad documental" CssClass="modal-title d-inline ml-1 mt-1"></asp:Label>
          ...
          <div id="contenido_botonoes" class="border_titulo_inferior modal-footer"  >
              <asp:Panel ID="panel_botones" runat="server">
                  <asp:UpdatePanel ID="Updatepanel_botones" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                      <ContentTemplate>
                          <asp:Button ID="ButtonRestaurar" runat="server" Text="Restaurar" ToolTip="Restaurar valores campos del expediente"  CssClass="btn btn-success" />
                          <asp:Button ID="ButtonAceptar" runat="server" Text="Actualizar" ToolTip="Actualizar expediente" style="display:none"  CssClass="btn btn-success" />
                          <asp:Button ID="ButtonAgregaVolumen" runat="server" Text="Agregar" ToolTip="Agregar volumen expediente" style="display:none"  CssClass="btn btn-success" />
                      </ContentTemplate>
                  </asp:UpdatePanel>
              </asp:Panel>
          </div>              
           <div id="Impresion_post">
            <asp:Panel ID="Panelimpresionpost" runat="server"  Style="display:none; color: White; width: auto; height: auto" CssClass="modal_content_general">
                ...
                <div id="divcabecer2_post" class="modal_title_superior">         
                    <asp:Label ID="Label15" runat="server" Text="Menú Impresion"  Style="float: left">
                    </asp:Label>
                    <div id="Divcerrarbuton2_post" style="float: right">
                        <asp:Button ID="Buttoncerrarimpre_post" runat="Server" Text="X" CssClass="modal_boton_hiden"
        ...
        <div id="modal_agregar_unidad_conservacion">
                <asp:Panel ID="Panel_agregar_unidad_conservacion_popup" runat="server"  Style="display:none; width: 100%; height: 99%" CssClass="modal_content_general">          
                    <asp:ModalPopupExtender ID="ModalPopupExtende_agregar_unidad_conservacion_popup" runat="Server" BackgroundCssClass="FondoAplicacion" TargetControlID="ButtonSalir_agregar_unidad_conservacion_popup"
                        PopupControlID="Panel_agregar_unidad_conservacion_popup" CancelControlID="Buttoncerrar_agregar_unidad_conservacion_popup" y="0">
                    </asp:ModalPopupExtender>
                    <div id="divcabecer_agregar_unidad_conservacion_popup" class="modal_title_superior" style="display:none">
                     ...
                     <div id="Contenido_agregar_unidad_conservacion_popup" style=" color: black; background-color: #FFFFFF; height: 97%; width: 100%" class="modal_content_back">
